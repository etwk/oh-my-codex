...
describe('agents model table', () => {
  ...
  it('builds table rows for summary roles and posture/modelClass-driven agent recommendations', () => {
    ...
    assert.match(table, /\| `architect` \| `gpt-frontier` \| xhigh \| System design, boundaries, interfaces, long-horizon tradeoffs \(frontier-orchestrator, frontier\) \|/);
    ...
    assert.match(table, /\| `critic` \| `gpt-frontier` \| xhigh \| Plan\/design critical challenge and review \(frontier-orchestrator, frontier\) \|/);
